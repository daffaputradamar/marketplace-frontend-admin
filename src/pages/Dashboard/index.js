			...
			<Container>
				<Grid>
							...
							<Menu.Item>
								...
								<Menu.Menu>
									<Menu.Item
										...
										onClick={(event) => setActiveItem(listActiveItem.konfirmasiAnggota)}
									/>
								</Menu.Menu>
							</Menu.Item>
							<Menu.Item>
							...
							<Menu.Item>
								...
								<Menu.Menu>
									<Menu.Item
										...
										onClick={(event) => setActiveItem(listActiveItem.konfirmasiPenarikan)}
									/>
								</Menu.Menu>
							</Menu.Item>
						</Menu>
					...
					<Grid.Column stretched width={12}>
						...
						{activeItem === listActiveItem.konfirmasiAnggota && <KonfirmasiAnggota />}
						...
						{activeItem === listActiveItem.konfirmasiPenarikan && <KonfirmasiPenarikan />}
					</Grid.Column>
				</Grid>
			</Container>
		</React.Fragment>
